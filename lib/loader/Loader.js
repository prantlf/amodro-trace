...
(function() {
  ...
  requirejs.s.newContext = function (name) {
    ...
    // Make the registry information available in the context
    // of the loader returned by trace()
    // TODO: Find out why the registry is empty there
  ...
  if (!requirejs.onResourceLoad) {
    ...
    requirejs.onResourceLoad = function (context, map) {
      ...
      // Remember important tracking information 
